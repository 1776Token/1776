...
This mechanism has been integrated into Bitcore-Node-SSS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SSS-Project/insight-api-sss#web-socket-api](https://github.com/SSS-Project/insight-api-sss#web-socket-api)
* API: [https://github.com/SSS-Project/insight-api-sss#swifttx-transactions](https://github.com/SSS-Project/insight-api-sss#swifttx-transactions)
...
By default, the SSS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SSS Core daemon:
