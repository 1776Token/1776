...
The following applies to code changes to the SSS Core project, and is not to be
confused with overall SSS Network Protocol consensus changes.

Whether a pull request is merged into SSS Core rests with the project merge
...
Patches that change SSS consensus rules are considerably more involved than
...
Where a patch set proposes to change the SSS consensus, it must have been
...
The project leader is the release manager for each SSS Core release.
