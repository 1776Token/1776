                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1776 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sss: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1776 Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1776 Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the 1776 Core help message to get a list with possible 1776 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1776 Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("1776 Core"); // default title
