...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1776 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 1776: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1776"), this);
    aboutAction->setStatusTip(tr("Show information about 1776"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1776"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1776 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1776 addresses"));
    ...
    openAction->setStatusTip(tr("Open a 1776: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 1776 help message to get a list with possible 1776 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1776 client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1776 network", "", count));
}
...
{
    QString strTitle = tr("1776"); // default title
