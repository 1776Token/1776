...
QT_TRANSLATE_NOOP("sss-core", ""
"Cannot obtain a lock on data directory %s. 1776 Core is probably already "
"running."),
QT_TRANSLATE_NOOP("sss-core", ""
...
QT_TRANSLATE_NOOP("sss-core", ""
"To use sssd, or the -server option to sss-qt, you must set an rpcpassword "
...
QT_TRANSLATE_NOOP("sss-core", ""
"Unable to bind to %s on this computer. 1776 Core is probably already running."),
QT_TRANSLATE_NOOP("sss-core", ""
...
"your clock is wrong 1776 Core will not work properly."),
QT_TRANSLATE_NOOP("sss-core", ""
...
QT_TRANSLATE_NOOP("sss-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("sss-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("sss-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("sss-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("sss-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("sss-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("sss-core", "Collateral not valid."),
...
QT_TRANSLATE_NOOP("sss-core", "Copyright (C) 2015-%i The ColossusCoinXT Core Developers"),
QT_TRANSLATE_NOOP("sss-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("sss-core", "Could not parse -rpcbind value %s as network address"),
...
QT_TRANSLATE_NOOP("sss-core", "Enable publish hash transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("sss-core", "Enable publish raw transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("sss-core", "Entries are full."),
QT_TRANSLATE_NOOP("sss-core", "Error connecting to Masternode."),
...
QT_TRANSLATE_NOOP("sss-core", "Error loading wallet.dat: Wallet requires newer version of 1776 Core"),
...
QT_TRANSLATE_NOOP("sss-core", "Error recovering public key."),
...
QT_TRANSLATE_NOOP("sss-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("sss-core", "Error: You already have pending entries in the Obfuscation pool"),
...
QT_TRANSLATE_NOOP("sss-core", "Finalizing transaction."),
QT_TRANSLATE_NOOP("sss-core", "Force safe mode (default: %u)"),
QT_TRANSLATE_NOOP("sss-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("sss-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("sss-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("sss-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("sss-core", "Initialization sanity check failed. 1776 Core is shutting down."),
QT_TRANSLATE_NOOP("sss-core", "Input is not valid."),
QT_TRANSLATE_NOOP("sss-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("sss-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("sss-core", "Invalid -proxy address: '%s'"),
...
QT_TRANSLATE_NOOP("sss-core", "Invalid private key."),
QT_TRANSLATE_NOOP("sss-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("sss-core", "Keep N SSS anonymized (default: %u)"),
QT_TRANSLATE_NOOP("sss-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("sss-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("sss-core", "Last successful Obfuscation action was too recent."),
...
QT_TRANSLATE_NOOP("sss-core", "Lock is already in place."),
...
QT_TRANSLATE_NOOP("sss-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("sss-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("sss-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("sss-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("sss-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("sss-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("sss-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("sss-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("sss-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("sss-core", "Node relay options:"),
QT_TRANSLATE_NOOP("sss-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("sss-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("sss-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("sss-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("sss-core", "Number of automatic wallet backups (default: 10)"),
QT_TRANSLATE_NOOP("sss-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("sss-core", "Obfuscation options:"),
QT_TRANSLATE_NOOP("sss-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("sss-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("sss-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("sss-core", "RPC server options:"),
QT_TRANSLATE_NOOP("sss-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("sss-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("sss-core", "Server private key (default: %s)"),
QT_TRANSLATE_NOOP("sss-core", "Session not complete!"),
...
QT_TRANSLATE_NOOP("sss-core", "Signing failed."),
...
QT_TRANSLATE_NOOP("sss-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("sss-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("sss-core", "Submitted to masternode, waiting in queue %s"),
QT_TRANSLATE_NOOP("sss-core", "SwiftTX options:"),
...
QT_TRANSLATE_NOOP("sss-core", "This is not a Masternode."),
...
QT_TRANSLATE_NOOP("sss-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("sss-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("sss-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("sss-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("sss-core", "Transaction too large"),
QT_TRANSLATE_NOOP("sss-core", "Transmitting final transaction."),
...
QT_TRANSLATE_NOOP("sss-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("sss-core", "Upgrade wallet to latest format"),
QT_TRANSLATE_NOOP("sss-core", "Use N separate masternodes to anonymize funds  (2-8, default: %u)"),
QT_TRANSLATE_NOOP("sss-core", "Use OpenSSL (https) for JSON-RPC connections"),
...
QT_TRANSLATE_NOOP("sss-core", "Value more than Obfuscation pool maximum allows."),
...
QT_TRANSLATE_NOOP("sss-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("sss-core", "Wallet needed to be rewritten: restart 1776 Core to complete"),
...
QT_TRANSLATE_NOOP("sss-core", "Will retry..."),
QT_TRANSLATE_NOOP("sss-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("sss-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("sss-core", "Your transaction was accepted into the pool!"),
