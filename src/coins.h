...
/** 
    ...
    ****Note - for 1776 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of 1776 coming in to a transaction
