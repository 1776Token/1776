...
( 0, uint256("000006533a058bf35e6b1116f0da8a2dd60c4de747ffc1a69408ebeb4415dd3f"))
        (177000, uint256("4289f70c3b546719b902ba2fac0cfda61000e19c92e18c8daef8c6d4b22e23f7"));
static const Checkpoints::CCheckpointData data = {
&mapCheckpoints,
1521456460, // * UNIX timestamp of last checkpoint block
363034,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        //vSeeds.clear();
      	...
      	vSeeds.push_back(CDNSSeedData("1776-seed.mergeseeders.com", "1776-seed.mergeseeders.com"));
        vSeeds.push_back(CDNSSeedData("1776-seed.mergeseeders.org", "1776-seed.mergeseeders.org"));
