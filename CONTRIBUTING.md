Contributing to 1776
============================

The 1776 project operates an open contributor model where anyone is
...
The following applies to code changes to the 1776 project, and is not to be
confused with overall 1776 Network Protocol consensus changes.

Whether a pull request is merged into 1776 rests with the project merge
...
Patches that change 1776 consensus rules are considerably more involved than
...
Where a patch set proposes to change the 1776 consensus, it must have been
...
The project leader is the release manager for each 1776 release.
