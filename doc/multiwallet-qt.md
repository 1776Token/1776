...
In order to support loading of multiple wallets in sss-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sss.cpp.
...
Changes to sss.cpp
----------------------
sss.cpp is the entry point into sss-qt, and as such, will require some minor modifications to provide hooks for
