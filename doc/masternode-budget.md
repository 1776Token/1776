...
1776 now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1776_address\> \<monthly_payment_1776\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ 1776, _12_ times over the course of a year totaling _24000_ 1776.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1776_address\> \<monthly_payment_1776\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` 1776.
 ...
 * vote-many          - Vote on a 1776 initiative
 * vote-alias         - Vote on a 1776 initiative
 * vote               - Vote on a 1776 initiative/budget
